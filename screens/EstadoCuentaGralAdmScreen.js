...
const EstadoCuentaGralAdmScreen = () => {
  ...
  const generaInforme = () => {  
    ...
    let url = "https://nobasys.com/api/ReporteECGPedregal2021.php?FECHA_INI=";
    //let url = "http://10.0.2.2:80/api/ReporteECGPedregal2021.php?FECHA_INI=";
    Linking.openURL(url + text + '&FECHA_FIN=' + textff);
    setCasa("");
    setTextff("");
    }  
  };
  ...
  return (
    <SafeAreaView style={[styles.container, {backgroundColor:theme.background}]}>
      <View >
        <Text style={styles.title}>Estado de Cuenta General</Text>
      </View>
      <View>
...
export default EstadoCuentaGralAdmScreen